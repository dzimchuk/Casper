...
!function(i){"use strict";i(document).ready(function(){"undefined"!=typeof github_url&&(i(".social-link-github").removeClass("hidden"),i(".social-link-github").attr("href",github_url)),"undefined"!=typeof linkedin_url&&(i(".social-link-linkedin").removeClass("hidden"),i(".social-link-linkedin").attr("href",linkedin_url))})}(jQuery);